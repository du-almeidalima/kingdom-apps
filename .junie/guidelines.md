...
These guidelines consolidate the rules created for the Kingdom Apps project. Junie should leverage these rules in every session to maintain project standards.

## Project Overview
**Kingdom Apps** is an Nx monorepo containing applications for ministry work.
