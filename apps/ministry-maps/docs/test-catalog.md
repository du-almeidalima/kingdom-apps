...
| UC-TERR-31 | Resolve `Revisita` truncates `recentHistory` ⚠   | Admin             | P1  | ✅ `territories-alerts.spec.ts`                                        | `territories-alerts.spec.ts`   | alert-resolution dialog PO            | revisit + unrelated MOVED            | ⚠                  |
...
| UC-STAT-03 | `Mudaram` from `recentHistory`      | Admin             | P1  | ✅ `territories-statistics.spec.ts` | `territories-statistics.spec.ts` | `StatisticsPage` | unresolved-MOVED territory    | ⚠ (5-cap caveat)        |
...
| UC-STAT-13 | Empty congregation (⚠ loading hang) | Admin (2nd cong.) | P2  | ✅ `territories-statistics.spec.ts` | `territories-statistics.spec.ts` | `StatisticsPage` | empty congregation + identity | HX-3, ⚠ (#42)         |
