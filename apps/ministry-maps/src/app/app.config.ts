  ...
  providers: [
    ...
    provideFirebaseApp(() =>
      initializeApp({
        ...
        appId: '1:409099617480:web:9741c57cdae9bde24a91fd',
        storageBucket: 'du-ministry-maps.firebasestorage.app',
        apiKey: 'AIzaSyBKb0Y28_ovK8S7ooKzDMSFT1VcL8HcQcs',
        authDomain: 'du-ministry-maps.firebaseapp.com',
        messagingSenderId: '409099617480',
        measurementId: 'G-N5SQ7XNV7X',
      })
    ),
    provideAuth(() => {
      const auth = getAuth();
