// Primary colors
export const primaryGreen = '#07AB3BFF';

// Red colors
export const red50 = '#fef7f7';
export const red100 = '#fee3e3';
export const red200 = '#fecbcb';
export const red300 = '#fca5a5';
export const red400 = '#f87678';
export const red500 = '#ef4545';
export const red600 = '#dc2727';
export const red700 = '#b91d1d';
export const red800 = '#991c1c';
export const red900 = '#7f1f1f';
export const red950 = '#431010';

// Orange colors
export const orange50 = '#fff8ed';
...
// Gray colors
export const gray100 = '#615D5C';
export const gray200 = '#4D4947';
export const gray300 = '#363332';
export const gray400 = '#202020';
...
export const grey100 = gray100;
export const grey200 = gray200;
export const grey300 = gray300;
export const grey400 = gray400;

// White colors (keeping existing custom whites)
export const white100 = '#FDFDFD';
export const white200 = '#F8F8F8';
export const white300 = '#E7E6E4';
export const white400 = '#D1D0CE';
export const white500 = '#BBBAB8';

// Link colors (domain-specific, keeping as is)
export const link = '#4171AEFF';
export const linkDark = '#2A4970FF';

// Button colors
export const blueBtn = '#2A4970';

// State colors
export const disabled = gray400;
export const disabledLight = '#8d8d8d';

// Typography colors
export const text = 'rgba(0, 0, 0, 0.87)';
export const textMedium = 'rgba(0, 0, 0, 0.60)';
export const textLow = 'rgba(0, 0, 0, 0.38)';
export const textPrimary = green500;
export const textSecondary = green100;
export const textError = red500;

// SHADOWS
export const shadowZ1 = '0 1px 3px rgba(0, 0, 0, 0.12), 0 1px 2px rgba(0, 0, 0, 0.24)';
export const shadowZ2 = '0 14px 28px rgba(0, 0, 0, 0.25), 0 10px 10px rgba(0, 0, 0, 0.22)';
export const shadowZ3 = '0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23)';
export const shadowZ4 = '0 10px 20px rgba(0, 0, 0, 0.19), 0 6px 6px rgba(0, 0, 0, 0.23)';
export const shadowZ5 = '0 14px 28px rgba(0, 0, 0, 0.25), 0 10px 10px rgba(0, 0, 0, 0.22)';
export const shadowZ6 = '0 19px 38px rgba(0, 0, 0, 0.30), 0 15px 12px rgba(0, 0, 0, 0.22)';

// SIZES
export const controlPadding = '.8rem';
export const iconButtonPadding = '.5rem';

// ANIMATIONS TIMING
export const backgroundTransition = '125ms ease-out background';
